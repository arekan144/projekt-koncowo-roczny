import { Scene, MeshPhongMaterial, TextGeometry, GridHelper, LoadingManager, AmbientLight, Clock, Vector3, Color, Box3, Font, Mesh, BoxGeometry, MeshBasicMaterial } from 'three';
...
import ptexture from "./assets/billywork.png"
import pgeometry from "./assets/tris.MD2"
...
export default class Main {
    ...
    init = async () => { // naprawienie tego sprawdzania, żeby tylko na jednym oknie w jednej przeglądarce
        ...
        this.socketHandler.num.then((response) => {
            ...
            if (this.num < 2) {
                ...
                this.player1.load(pgeometry, ptexture)
                this.player2 = new Player(this.manager)
                this.player2.load(pgeometry, ptexture)
                ...
                this.manager.onLoad = () => {
                    ...
                    this.animation1 = new Animation(this.player1.mesh)
                    this.animation2 = new Animation(this.player2.mesh)
                    //////////
    ...
    render = async () => {
        ...
        let p2Pos = new Vector3(this.player2.mesh.position.x, this.player2.mesh.position.y, this.player2.mesh.position.z)
